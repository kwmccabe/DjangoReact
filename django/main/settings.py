...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            ...
            'format': '{asctime} {process:d} {levelname} {name} {lineno:d} {message}',
            'style': '{',
        },
        'simple': {
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('SQL_PASS',      'sql_pass'),
...
# DjangoModelPermissionsOrAnonReadOnly = standard `django.contrib.auth` or read-only for unauthenticated users.
REST_FRAMEWORK = {
